...
public class UdpSocket_PCB : MonoBehaviour
{
    public bool isTxStarted = false;

    [SerializeField] string IP = "192.168.0.255"; // local host
    [SerializeField] int rxPort = 5325; // port to receive data from Python on

    [SerializeField] int txPort = 5325; // port to send data to Python on<AI>
     // port to send data to Python on<TOF>
    ...
    void Awake()
    {
        ...
        print("UDP_PCB Comms Initialised");
