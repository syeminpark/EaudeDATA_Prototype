...
public class UDPSock : MonoBehaviour
{
    public bool isTxStarted = false;

    [SerializeField] string IP = "127.0.0.1"; // local host
    [SerializeField] int rxPort = 8004; // port to receive data from Python on

    [SerializeField] int txPort = 8003; // port to send data to Python on<AI>
